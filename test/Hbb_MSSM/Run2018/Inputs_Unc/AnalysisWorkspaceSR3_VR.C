...
int AnalysisWorkspaceSR3_VR()
{
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_signal_in_unbinned_JER_Up = new TFile(dir + "/input_doubleCB/signal_m" + Tsrmasses[mass] + "_SR3_JER_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JER_Down = new TFile(dir + "/input_doubleCB/signal_m" + Tsrmasses[mass] + "_SR3_JER_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Up = new TFile(dir + "/input_doubleCB/signal_m" + Tsrmasses[mass] + "_SR3_JES_1sigmaup.root", "READ");
		...
		//Output file
		TFile *fOut = new TFile("input_2018_FH_VR/signal_workspace_" + Tsrmasses[mass] + "_SR3.root", "RECREATE");
