...
int AnalysisWorkspaceSR1()
{
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_signal_in_unbinned = new TFile("/nfs/dust/cms/user/consuegs/Analyses/Hbb_MSSM/analysis-mssmhbb/test/Hbb_MSSM/Run2018/input_doubleCB_Feb23/signal_m" + Tsrmasses[mass] + "_SR1.root", "READ");
		...
		double a_centralValue = 0.000306986;
		double b_centralValue = 0.0643444;
