...
#cd ../../
combine -M FitDiagnostics --robustHesse 1 --cminDefaultMinimizerTolerance 0.01 --X-rtd MINIMIZER_analytic --cminDefaultMinimizerStrategy=0 --X-rtd FITTER_NEW_CROSSING_ALGO --expectSignal=${mu} -t -1 --rMin=-10 --rMax=10 -m ${mass} ${1}.txt -v 5 
