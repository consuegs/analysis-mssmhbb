...
int AnalysisWorkspaceSR4_VR()
{
	...
	vector<double> lumiscalefactors = { 35.77, 34.61, 34.05, 33.24, 31.45 };	//SR4
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_bgfit = new TFile(dir + "/workspaces_bkg_CR/4FRs/FR4/500to2000/extnovosibirsk/workspace/FitContainer_workspace.root", "READ");
		...
		TFile *f_signal_in_unbinned = new TFile("/nfs/dust/cms/user/consuegs/Analyses/Hbb_MSSM/analysis-mssmhbb/test/Hbb_MSSM/Run2018/input_doubleCB_Feb23/signal_m" + Tsrmasses[mass] + "_SR4.root", "READ");
		...
		double a_centralValue = 0.000299457;
		double b_centralValue = 0.0700571;
		...
		//Output file
		TFile *fOut = new TFile("input_2018_FH_VR/signal_workspace_" + Tsrmasses[mass] + "_SR4.root", "RECREATE");
