...
do
    ...
    do
	    ...
	    #fi
        cd datacards_2017TF
	    cp ../datacard_Analysis_template_2017TF.txt hbb_mbb${mass}_SR1_mssm-13TeV.txt
...
do
    ...
    do
        ...
        #fi
        cd datacards_2017TF
	    cp ../datacard_Analysis_template_2017TF.txt hbb_mbb${mass}_SR2_mssm-13TeV.txt
...
do
    ...
    do
        ...
        #fi
        cd datacards_2017TF
	    cp ../datacard_Analysis_template_2017TF.txt hbb_mbb${mass}_SR3_mssm-13TeV.txt
...
do
    ...
    do
        ...
        #fi
        cd datacards_2017TF
	    cp ../datacard_Analysis_template_2017TF.txt hbb_mbb${mass}_SR4_mssm-13TeV.txt
