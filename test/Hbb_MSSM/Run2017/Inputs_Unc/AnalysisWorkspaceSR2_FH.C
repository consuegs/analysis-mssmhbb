...
int AnalysisWorkspaceSR2_FH()
{
	...
	vector<double> lumiscalefactors = { 53.94, 54.09, 54.46, 55.39, 59.7 };	//SR2
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_signal_in_unbinned_JER_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR2_JER_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JER_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR2_JER_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR2_JES_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR2_JES_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JKTE_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR2_JKTE_1sigmaup.root", "READ");
                ...
                TFile *f_signal_in_unbinned_JKTE_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR2_JKTE_1sigmadown.root", "READ");
		...
		//Output file
		TFile *fOut = new TFile("input_2017_FH/signal_workspace_" + Tsrmasses[mass]  + "_SR2.root", "RECREATE");
