...
int AnalysisWorkspaceSR4_FH()
{
	...
	std::ofstream textout("figs/AnalysisWorkspaceSR4_FH.txt");
	...
	vector<double> lumiscalefactors = { 56.52, 54.51, 54.45, 53.08, 49.24 };	//SR4
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_signal_in_unbinned_JER_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR4_JER_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JER_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR4_JER_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR4_JES_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR4_JES_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JKTE_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR4_JKTE_1sigmaup.root", "READ");
                ...
                TFile *f_signal_in_unbinned_JKTE_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR4_JKTE_1sigmadown.root", "READ");
