...
int AnalysisWorkspaceSR3_FH()
{
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_signal_in_unbinned_JER_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR3_JER_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JER_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR3_JER_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR3_JES_1sigmaup.root", "READ");
		...
		TFile *f_signal_in_unbinned_JES_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR3_JES_1sigmadown.root", "READ");
		...
		TFile *f_signal_in_unbinned_JKTE_Up = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR3_JKTE_1sigmaup.root", "READ");
                ...
                TFile *f_signal_in_unbinned_JKTE_Down = new TFile(dir + "/input_doubleCB_FH/signal_m" + Tsrmasses[mass] + "_SR3_JKTE_1sigmadown.root", "READ");
