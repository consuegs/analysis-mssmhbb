...
int AnalysisWorkspaceSR4_SL()
{
	...
	RooRealVar mbb("mbb", "m_{12}", 350, 800);	//SR4: 600, 700
	RooArgList vars(mbb);
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TFile *f_bgfit = new TFile(dir + "/forSandra/Feb2022_v6/SL/UL2017_background_novosibirsk_350to800_5GeV/workspace/FitContainer_workspace.root", "READ");
