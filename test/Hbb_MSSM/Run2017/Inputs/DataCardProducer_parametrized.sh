...
do
    ...
    do
        ...
        cd datacards_parametrized
	    cp ../datacard_Analysis_template_parametrized.txt hbb_mbb${mass}_SR1_mssm-13TeV.txt
...
do
    ...
    do
        ...
        cd datacards_parametrized
	    cp ../datacard_Analysis_template_parametrized.txt hbb_mbb${mass}_SR2_mssm-13TeV.txt
...
do
    ...
    do
        ...
        cd datacards_parametrized
	    cp ../datacard_Analysis_template_parametrized.txt hbb_mbb${mass}_SR3_mssm-13TeV.txt
...
do
    ...
    do
        ...
        cd datacards_parametrized
	    cp ../datacard_Analysis_template_parametrized.txt hbb_mbb${mass}_SR4_mssm-13TeV.txt
