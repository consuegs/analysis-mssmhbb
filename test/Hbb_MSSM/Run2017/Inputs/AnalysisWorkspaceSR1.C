...
int AnalysisWorkspaceSR1()
{
	...
	vector<double> lumiscalefactors = { 142.9, 89.57, 69.29, 68.83, 75.24 };	//SR1
	vector<string> allmasses = { "300", "325", "350", "375", "400" };	//SR1

	TString Tsrmasses[5] = { "300", "325", "350", "375", "400" };	//SR1
	...
	vector<string> srmasses = { "300", "325", "350", "375", "400" };
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		//Output file
		TFile *fOut = new TFile(("input/ReReco_signal_M-" + srmasses[mass] + "/workspace/SR1/signal_workspace.root").c_str(), "RECREATE");
