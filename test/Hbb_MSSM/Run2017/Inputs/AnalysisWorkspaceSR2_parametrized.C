...
int AnalysisWorkspaceSR2_parametrized()
{
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		TH1F *h_JERUp_in = (TH1F*) f_JERUp_in->Get("m12_" + Tsrmasses[mass] + "GeV_SR2_1GeVbinning");
		...
		TH1F *h_JERDown_in = (TH1F*) f_JERDown_in->Get("m12_" + Tsrmasses[mass] + "GeV_SR2_1GeVbinning");
		...
		TH1F *h_JESUp_in = (TH1F*) f_JESUp_in->Get("m12_" + Tsrmasses[mass] + "GeV_SR2_1GeVbinning");
		...
		TH1F *h_JESDown_in = (TH1F*) f_JESDown_in->Get("m12_" + Tsrmasses[mass] + "GeV_SR2_1GeVbinning");
		...
		TFile *f_bgfit = new TFile("../Inputs_Paul/FinalVersionAnalysis2017FH/BGparam/260to785/workspace/FitContainer_workspace.root", "READ");	//SR2
		...
		//Output file
		TFile *fOut = new TFile(("input_parametrized/ReReco_signal_M-" + srmasses[mass] + "/workspace/SR2/signal_workspace.root").c_str(), "RECREATE");
