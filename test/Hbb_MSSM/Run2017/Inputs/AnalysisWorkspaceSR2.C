...
int AnalysisWorkspaceSR2()
{
	...
	vector<double> lumiscalefactors = { 75.24, 77.83, 75.45, 64.51, 77.85, 70.42 };	//SR2
	vector<string> allmasses = { "400", "425", "450", "500", "600", "700" };	//SR2

	TString Tsrmasses[6] = { "400", "425", "450", "500", "600", "700" };	//SR2
	...
	vector<string> srmasses = { "400", "425", "450", "500", "600", "700" };
	...
	for (unsigned int mass = 0; mass < srmasses.size(); mass++)
	{
		...
		//Output file
		TFile *fOut = new TFile(("input/ReReco_signal_M-" + srmasses[mass] + "/workspace/SR2/signal_workspace.root").c_str(), "RECREATE");
