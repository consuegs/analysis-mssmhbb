...
#data
echo "Submitting to condor for testing 100 events, JetHT_Run2017C-deep-CR-3j data"
naf_submit.py --exe SimpleMssmHbbAnalysis_2017 --config JetHT_Run2017C-deep-CR-3j_test.cfg --nfiles 1
...
#data
echo "Running locally for testing on 100 events, JetHT_Run2017C-deep-CR-3j data"
SimpleMssmHbbAnalysis_2017 -c JetHT_Run2017C-deep-CR-3j_test.cfg 
