...
do
    echo "Resubmit jobs for data sample " ${samples_data[$j]}-deep-$1-3j 
    naf_submit.py --dir Condor_SimpleMssmHbbAnalysis_2017_${samples_data[$j]}-deep-$1-3j --resubmit
...
do
    echo "Resubmit jobs for signal sample " mc-sig-${k}-NLO-deep-$1-3j
    naf_submit.py --dir Condor_SimpleMssmHbbAnalysis_2017_mc-sig-${k}-NLO-deep-$1-3j --resubmit
...
do
    echo "Resubmit jobs for background MC sample " ${samples_bkgMC[$l]}-deep-$1-3j
    naf_submit.py --dir Condor_SimpleMssmHbbAnalysis_2017_${samples_bkgMC[$l]}-deep-$1-3j --resubmit
