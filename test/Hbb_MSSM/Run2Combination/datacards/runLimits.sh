...
do
  ...
  combineCards.py Run2017_FH=hbb_mbb${mass}_SR3_mssm-13TeV_2017_FH.txt Run2018_FH=hbb_mbb${mass}_SR3_mssm-13TeV_2018_FH.txt Run2017_SL=hbb_mbb${mass}_SR3_mssm-13TeV_2017_SL.txt > hbb_mbb${mass}_SR4_mssm-13TeV_Run2.txt
