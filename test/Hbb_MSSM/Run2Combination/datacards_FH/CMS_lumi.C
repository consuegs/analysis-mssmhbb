...
{            
  ...
  if( iPeriod==1 )
   ...
   else if ( iPeriod==12 )
    {
      ...
      lumiText += "(13 TeV, Run2)";
    }
   

  else if ( iPeriod==13 )
    {
      lumiText = lumi_13TeV_2017and2018;
      lumiText += " (13 TeV, 2017+2018)";
    }
/*
  else if ( iPeriod==12 )
    {
      lumiText = lumi_13TeV_Run2;
      lumiText += " (13 TeV)";
//      lumiText += " (13 TeV, 2016+2017+2018)";
    }
*/   
  cout << lumiText << endl;
  ...
  if( outOfFrame )
    {
      ...
      latex.DrawLatex(l+0.12,1-t+lumiTextOffset*t, extraText); 
    }
